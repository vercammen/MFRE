...
# convert country name in data to standardized name used by R (required for graphing)
...
# clear environment and plots, and load packages
rm(list=ls())
graphics.off()
# close all plots
...
# calculate real price and add as a new column
...
bilateral <- read.csv(file="./Data/trade.csv", header=TRUE, sep=",")
